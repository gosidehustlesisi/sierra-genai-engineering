<div align="center">
  ...
  <p><strong>4,154+ real documents · 6 projects · 12+ notebooks · 15+ charts</strong></p>
</div>
...
|--------|-----------|---------|--------|
| **arXiv API** | Live ML/AI/NLP research abstracts | 2,651+ | Live |
| **PubMed E-utilities** | Biomedical trial outcomes & biomarkers | 42+ | Live |
| **SCOTUS** | Landmark majority opinions (public domain) | 15 | Archived |
| **Wikipedia API** | Legal & financial encyclopedia articles | 991 | Live |
| **U.S. Census ACS** | State-level demographics | 50 states | Live |
| **BLS Public Data** | Employment time series | 72 months | Live |

**Zero synthetic data. Zero `generate_data.py`. Every document was fetched from a live public API or downloaded from an official government/research portal.**

---

## At a Glance

| **Project** | **Documents** | **Source** | **Status** |
|---|---|---|---|
| RAG Knowledge Base | 2,651 arXiv abstracts | arXiv API (export.arxiv.org) | Live |
| LLM Document Classification | 991 (arXiv + PubMed + Wikipedia) | 3 live APIs | Live |
| arXiv Research Classifier | 450 papers | arXiv API | Live |
| PubMed Research | 42 biomedical records | PubMed E-utilities | Live |
| SCOTUS Opinions | 15 landmark cases | Public domain court records | Archived |
| AI-Ready MLOps | Infrastructure template | Census + BLS + arXiv (plug your own) | Template |

**Total real documents: 4,154+**
